                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          BlocBuilder<StudentSignUpCubit, StudentSignUpState>(
                            builder: (_, studentSignUpState) => ElevatedButton(
                              style: ButtonStyle(
                                backgroundColor:
                              ...
                              onPressed: studentSignUpState
                                      is! SigningUpStudentState
                                  ? () {
                                      if (_formKey.currentState?.validate() ??
                                          false) {
                                        context
                                            .read<StudentSignUpCubit>()
                                            .signUpStudent(
                                              name: _nameController.text,
                                              email: _emailController.text,
                                              degreeType:
                                                  _degreeTypeNotifier.value!,
                                              courseOfStudy:
                                                  _courseOfStudyNotifier.value!,
