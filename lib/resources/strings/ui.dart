...
const signUpAsAStudent = 'Sign up as a student';
const or = 'or';
const signUpAsASupervisor = 'Sign up as a supervisor';
const name = 'Name';
const email = 'Email';
const password = 'Password';
const degreeType = 'Degree type';
const courseOfStudy = 'Course of study';
const regNo = 'Reg. no.';
const status = 'Status';
...
const hi = 'Hi';
const firstChatBotPrompt =
    'Please start by providing your project topic, then any other questions that you may have';
const askMeAnything = 'Ask me anything...';
const invalidLink = 'The provided link is invalid';
